...
public class Queen extends Piece {
    ...
    private final static int[] CANDIDATE_MOVR_VECTOR_COORDINATES = {-9, -8, -7, -1, 1, 7, 8, 9};
    ...
    private static boolean isEighthColumnExclusion(final int currentCandidate, final int candidateDestinationCoordinate) {
        return (BoardUtils.EIGHTH_COLUMN[candidateDestinationCoordinate] && ((currentCandidate == -7) || (currentCandidate == 9) || (currentCandidate == -1)));
    }
}
